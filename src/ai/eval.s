...
PAWN_ATTACK_MINOR_PENALTY = 0
PAWN_ATTACK_ROOK_PENALTY = 0
PAWN_ATTACK_QUEEN_PENALTY = 0
QUEEN_ATTACK_MINOR_PENALTY = 0
MINOR_ATTACK_ROOK_PENALTY = 70
MINOR_ATTACK_QUEEN_PENALTY = 0
KNIGHT_OUTPOST_BONUS = 0
PINNED_PAWN_PENALTY = 0
PINNED_MINOR_PENALTY = 62
PINNED_ROOK_PENALTY = 87
PINNED_QUEEN_PENALTY = 112
PINNED_ATTACKED_PENALTY = 100

;
; Pawn Structure Evaluation Constants
;
DOUBLED_PAWN_PENALTY = 37
ISOLATED_PAWN_PENALTY = 0
PASSED_PAWN_BONUS_BASE = 200
ADVANCED_PAWN_BONUS = 0
DEEP_ADVANCED_PAWN_BONUS = 0
ROOK_BEHIND_PASSER_BONUS = 150
CONNECTED_PASSER_BONUS = 0
PROTECTED_PASSER_BONUS = 0
BLOCKADED_PASSER_PENALTY = 150
BISHOP_PAIR_BONUS = 50
ROOK_OPEN_FILE_BONUS = 0
ROOK_SEMI_OPEN_FILE_BONUS = 30
HEAVY_SEVENTH_RANK_BONUS = 0
ENDGAME_NONPAWN_LIMIT = 1; K+P and single-piece endings (a COUNT, not eval units)
ENDGAME_KING_ACTIVITY_BONUS = 0
ENDGAME_ROOK_OPEN_FILE_BONUS = 150
ENDGAME_ROOK_KING_CUTOFF_BONUS = 0
...
;
CASTLED_BONUS = 0; Bonus for being on castled squares
PAWN_SHIELD_BONUS = 0; Bonus per pawn in shield
OPEN_FILE_PENALTY = 0; Penalty for open file near king
SEMI_OPEN_FILE_PENALTY = 0; Penalty for half-open file near king
KING_CENTER_PENALTY = 0; Penalty for king in center in middlegame
KING_MARCH_BASE = 0; Flat middlegame penalty once the king leaves ranks 1-2

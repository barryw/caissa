...
| --- | ---: | ---: |
| easy mate in one | 1,868,975 | 2,400,000 |
| medium mate in one | 1,869,009 | 2,400,000 |
| hard mate in one | 1,869,009 | 2,400,000 |
| depth-1 hanging queen search | 741,669 | 950,000 |
| hard hanging queen | 481,943 | 700,000 |
| depth-5 middlegame search | 3,985,622 | 5,000,000 |
...
| `CODE` | `$0801-$50cd` | 18,637 |
| `BSS` | `$50ce-$644c` | 4,991 |
| PRG payload | | 18,639 |
| runtime footprint | | 23,630 |

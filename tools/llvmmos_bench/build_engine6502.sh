...
ASM_OVERRIDE="$NATIVE/is_square_attacked_6502.s $NATIVE/unmake_move_6502.s $NATIVE/make_move_6502.s $NATIVE/order_moves_6502.s"
# shellcheck disable=SC2086
"$SIMCC" -Os -DCREF_ASM_IS_SQUARE_ATTACKED -DCREF_ASM_UNMAKE_MOVE -DCREF_ASM_MAKE_MOVE -DCREF_ASM_ORDER_MOVES -I"$NATIVE" engine6502.c $CORE $ASM_OVERRIDE \
